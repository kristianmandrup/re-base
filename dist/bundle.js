...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	  ...
	  var $q = __webpack_require__(2); // for timeout promise
	  ...
	  function timeout(ref, eventType) {
	    var timeOut = arguments.length <= 2 || arguments[2] === undefined ? { period: 2000 } : arguments[2];

	    var deferred = (timeOut.q || $q).defer();
	    $timeout(function () {
	      deferred.reject("TIMEOUT");
	    }, timeOut.period);
	    ref.once(eventType, function (data) {
